...
* */
@Component
public class FactoryBeanHandler implements FactoryBean<FactoryBeanHandler.FactoryInnerBean> {

    @Override
    public FactoryBeanHandler.FactoryInnerBean getObject() throws Exception {
        System.out.println("[FactoryBeanHandler] getObject");
        return new FactoryBeanHandler.FactoryInnerBean();
    }

    @Override
    public Class<?> getObjectType() {
        return FactoryBeanHandler.FactoryInnerBean.class;
    }
